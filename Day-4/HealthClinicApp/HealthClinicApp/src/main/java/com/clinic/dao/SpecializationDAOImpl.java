...
public class SpecializationDAOImpl implements SpecializationDAO {
    ...
    public Specialization getSpecializationById(int id) {
        ...
        try (Connection conn = HikariConnectionPool.getConnection();
            ...
            System.out.println("Query specialization failed: " + e.getMessage());
        }
        return null;
    }
    ...
    public boolean updateSpecialization(Specialization spec) {
        ...
        try (Connection conn = HikariConnectionPool.getConnection();
            ...
            pstmt.setString(1, spec.getName());
            pstmt.setString(2, spec.getDescription());
            pstmt.setInt(3, spec.getSpecializationId());
    ...
    public boolean deleteSpecialization(int id) {
        ...
        try (Connection conn = HikariConnectionPool.getConnection();
            ...
            System.out.println("Delete specialization failed (it may still be assigned to a doctor): " + e.getMessage());
            return false;
        }
    }
